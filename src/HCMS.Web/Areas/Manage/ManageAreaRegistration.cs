    ...
    public class ManageAreaRegistration : AreaRegistration
    {
        ...
        public override void RegisterArea(AreaRegistrationContext context)
        {
            ...
            context.MapRoute(
                            ...
                            new { controller = "Dynamics", AreaName = "Manage", ln = "fa", cn = "ir", action = "Index", id = UrlParameter.Optional }
                            );
            ...
            context.MapRoute(
                                ...
                                new { controller = "Dashboard", AreaName = "Manage", ln = "fa", cn = "ir", action = "Index", id = UrlParameter.Optional }
                            );
