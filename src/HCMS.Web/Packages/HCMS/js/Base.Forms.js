...
var InitBaseForms = function () {
    ...
    function Add_Multiple_Entry_Field(element) {
        ...
        $(TargetInputClone).removeAttr('data-value');
        $('option', TargetInputClone).removeAttr('selected');
        $('option', TargetInputClone).first().attr('selected','selected');
    ...
    var cons = function () {
        ...
        //  $('form.dynamics-form select').select2();
